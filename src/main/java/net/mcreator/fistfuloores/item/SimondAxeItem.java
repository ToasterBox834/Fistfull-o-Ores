...
public class SimondAxeItem extends FistfulOOresModElements.ModElement {
	@ObjectHolder("fistful_o_ores:simond_axe")
	public static final Item block = null;
	public SimondAxeItem(FistfulOOresModElements instance) {
		super(instance, 29);
	}
