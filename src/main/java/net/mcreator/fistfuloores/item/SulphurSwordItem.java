...
public class SulphurSwordItem extends FistfulOOresModElements.ModElement {
	@ObjectHolder("fistful_o_ores:sulphur_sword")
	public static final Item block = null;
	public SulphurSwordItem(FistfulOOresModElements instance) {
		super(instance, 46);
	}
