...
public class SimondHoeItem extends FistfulOOresModElements.ModElement {
	@ObjectHolder("fistful_o_ores:simond_hoe")
	public static final Item block = null;
	public SimondHoeItem(FistfulOOresModElements instance) {
		super(instance, 32);
	}
