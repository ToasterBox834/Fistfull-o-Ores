...
public class ScopperShovelItem extends FistfulOOresModElements.ModElement {
	@ObjectHolder("fistful_o_ores:scopper_shovel")
	public static final Item block = null;
	public ScopperShovelItem(FistfulOOresModElements instance) {
		super(instance, 10);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("scopper_shovel"));
	}
}
