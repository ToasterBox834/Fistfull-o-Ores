...
public class SulphurShovelItem extends FistfulOOresModElements.ModElement {
	@ObjectHolder("fistful_o_ores:sulphur_shovel")
	public static final Item block = null;
	public SulphurShovelItem(FistfulOOresModElements instance) {
		super(instance, 47);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("sulphur_shovel"));
	}
}
