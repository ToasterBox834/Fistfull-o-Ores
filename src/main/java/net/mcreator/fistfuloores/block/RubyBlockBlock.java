...
public class RubyBlockBlock extends FistfulOOresModElements.ModElement {
	@ObjectHolder("fistful_o_ores:ruby_block")
	public static final Block block = null;
	public RubyBlockBlock(FistfulOOresModElements instance) {
		super(instance, 61);
	}
