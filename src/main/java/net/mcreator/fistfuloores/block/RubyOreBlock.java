...
import net.mcreator.fistfuloores.item.RubyItem;
...
public class RubyOreBlock extends FistfulOOresModElements.ModElement {
	@ObjectHolder("fistful_o_ores:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(FistfulOOresModElements instance) {
		super(instance, 60);
	}
