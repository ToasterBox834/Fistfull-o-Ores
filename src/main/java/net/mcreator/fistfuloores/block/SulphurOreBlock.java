...
import net.mcreator.fistfuloores.item.SulphurDustItem;
...
public class SulphurOreBlock extends FistfulOOresModElements.ModElement {
	@ObjectHolder("fistful_o_ores:sulphur_ore")
	public static final Block block = null;
	public SulphurOreBlock(FistfulOOresModElements instance) {
		super(instance, 39);
	}
